...
def caesar_cipher(message, shift):
    ...
    for l in range(len(letters)):
        if l != " ":
            if alphabet.index(letters[l]) + shift < len(alphabet):
                shifted_letter_pos = alphabet.index(letters[l]) + shift
                letters[l] = alphabet[shifted_letter_pos]
            else:
                shifted_letter_pos = (alphabet.index(letters[l]) + shift) % len(alphabet)
                letters[l] = alphabet[shifted_letter_pos]
    shifted = ''.join(letters)
    return shifted
...
def vigenere_cipher(message, key):
    ...
    #This code was created with the aid of justcryptography.com and modified by me. 
...
def scytale_cipher(message, shift):
    ...
    for i in range(len(message)):
        l = (i // shift) + (len(message) // shift) * (i % shift)
        em += message[l]
    return em
