...
def interest(principal, rate, periods):
    ...
    inter = prin*(a_rate*peri)
    gross_gained = prin+inter
    final_gained = int(gross_gained)
...
def body_mass_index(weight, height):
    ...
    height_f = int(height[0])
    height_i = int(height[1])
    
    f_height = float((height_i*0.0254)+(height_f*0.3048))
    bmi = float(weight_kg/f_height**2)
